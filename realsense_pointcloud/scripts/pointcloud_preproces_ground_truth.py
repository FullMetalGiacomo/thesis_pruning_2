...
#########################################3 creation of mask plant from color images
        ...
        depth_image_rect_copy_2=np.copy(depth_image_rect_copy)
        color_image_rect_copy_2=np.copy(color_image_rect)
        color_image_rect_copy_2 = cv2.cvtColor(color_image_rect_copy_2, cv2.COLOR_BGR2RGB)
